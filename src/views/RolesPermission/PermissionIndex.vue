        ...
        <div class="mt-5 relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div v-else>
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="(permission, index) in permissions" :key="index" class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <td class="flex items-center px-6 py-4 space-x-3">
                                <button v-if="permission.id"  @click="openEditModal(permission.id)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</button>
                                <button @click="onRemove(permission?.id)" class="font-medium text-red-600 dark:text-red-500 hover:underline">Remove</button>
...
function savePermission(e) {
    ...
    const apiCall = isEditing.value ? store.updatePermission : store.createPermissions
