<template>
  ...
  >
    ...
    <div
      class="mt-3 p-4 md:mx-auto md:w-full md:max-w-lg xl:max-md sm:mx-auto sm:w-full sm:max-w-md bg-white border border-gray-200 rounded-lg shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700"
    >
      <div v-if="isLoading" class="text-center">
        <div role="status">
          <svg
            aria-hidden="true"
            class="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-emerald-500"
            viewBox="0 0 100 101"
            fill="none"
      ...
      <form @submit="register">
        <div class="grid gap-6 mb-6 md:grid-cols-2 max-w-lg">
          ...
          <div>
            ...
            <div class="flex">
              <span
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg px-1 py-2.5 flex items-center dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              >
                {{ prefix }}
              </span>
              <input
                ...
                :maxlength="9"
                pattern="[0-9]*"
                class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-emerald-500 focus:border-emerald-500 flex-1 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
          ...
          <div class="mb-6 mt-3">
            ...
            <div
              v-if="validationErr.password_confirmation"
              class="text-red-500 text-xs mt-1"
            >
        ...
        <div class="mt-6">
          <button
            type="submit"
            @click="showLoading"
            class="flex w-full justify-center rounded-md bg-emerald-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Sign up
          </button>
        </div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <router-link
          :to="{ name: 'Login' }"
          class="font-semibold leading-6 text-emerald-500 hover:text-indigo-500"
...
function validateForm() {
  ...
  if (!user.value.password_confirmation) {
    validationErr.value.password_confirmation = [
